...
import { idlFactory } from './opened_backend.did.js';
export { idlFactory } from './opened_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.OPENED_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./opened_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the opened_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./opened_backend.did.js")._SERVICE>}
 */
export const opened_backend = createActor(canisterId);
