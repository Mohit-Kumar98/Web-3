...
import { idlFactory } from './opened_frontend.did.js';
export { idlFactory } from './opened_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.OPENED_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./opened_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the opened_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./opened_frontend.did.js")._SERVICE>}
 */
export const opened_frontend = createActor(canisterId);
