...
document.querySelector("form").addEventListener("submit", async function(event){
  ...
  {
    await _declarations_dbank_backend__WEBPACK_IMPORTED_MODULE_0__.dbank_backend.withdrawal(outputAmount);
  }

    await _declarations_dbank_backend__WEBPACK_IMPORTED_MODULE_0__.dbank_backend.compound();
