...
export const canisterId = process.env.DBANK_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dbank_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dbank_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dbank_backend.did.js")._SERVICE>}
 */
export const dbank_backend = createActor(canisterId);
