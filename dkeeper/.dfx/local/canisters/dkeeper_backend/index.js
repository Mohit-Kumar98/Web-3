...
export const canisterId = process.env.DKEEPER_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dkeeper_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dkeeper_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dkeeper_backend.did.js")._SERVICE>}
 */
