...
export const canisterId = process.env.DKEEPER_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dkeeper_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dkeeper_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dkeeper_frontend.did.js")._SERVICE>}
 */
